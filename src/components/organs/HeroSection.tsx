...
const backgroundColor = "#89CFF0"; // Replace with your desired background color
    
const HeroSection = () => {
    return (
        <section className="w-full lg:h-screen md:h-[550px] h-[830px] relative overflow-x-hidden flex justify-end" style={{ backgroundColor }} >
            ...
            <div className="flex flex-col justify-center md:gap-6 gap-3 md:order-1 order-2">
                    <Text as="p" className="text-color5 uppercase tracking-widest lg:text-base text-sm font-normal" style={{ color: '#FF0000' /* Replace with your desired text color */ }}>
                        <Fade>{HeroTexts.firstText}</Fade>

                    </Text>
                    <Text as="h1" className=" text-color6 lg:text-7xl md:text-5xl text-3xl font-medium">
                        <Fade>{HeroTexts.secondText}</Fade>
                    </Text>
                    <Text as="p" className="text-color6 md:text-base text-sm text-justify font-light">
                    ...
                    <div className="w-full flex md:justify-start justify-between items-center lg:gap-12 md:gap-6 gap-0">
                        <Button type="button" className="outline-none border-none lg:px-7 px-5 py-3 bg-color3 text-white font-extralight rounded-lg">
                        ...
                        <div className="flex items-center lg:gap-6 gap-3 cursor-pointer">
                            <Text as="span" className="relative flex h-14 w-14">
                                ...
                                <Text as="span" className="relative flex justify-center items-center text-white rounded-full h-14 w-14 bg-color3">
